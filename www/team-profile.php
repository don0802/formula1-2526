        ...
        <div class="max-w-3xl w-full">
            <?php if ($constructor): ?>
                <div class="bg-gray-800 rounded-lg p-8 shadow-2xl">
                    <h1 class="text-4xl font-bold mb-8 text-center bg-gradient-to-r from-red-500 to-red-400 bg-clip-text text-transparent">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center">
                        <div class="bg-gray-700 rounded-lg p-6">
                            ...
                            <p class="text-2xl text-red-500 font-bold mt-2"><?php echo $constructor['constructorId']; ?></p>
                        </div>
                        
                        <div class="bg-gray-700 rounded-lg p-6">
                            <span class="text-gray-300 text-xs uppercase tracking-wider font-semibold">Reference</span>
                            <p class="text-2xl font-bold mt-2"><?php echo $constructor['constructorRef']; ?></p>
                        </div>
                        
                        <div class="bg-gray-700 rounded-lg p-6">
                            <span class="text-gray-300 text-xs uppercase tracking-wider font-semibold">Nationality</span>
                            <p class="text-2xl font-bold mt-2"><?php echo $constructor['nationality']; ?></p>
                        </div>
